...
#solution()[
  #block(inset: 8pt, stroke: (thickness: 1pt, dash: "dashed", paint: red))[#smallcaps()[#text(fill: red, weight: "bold")[Level 0]]]
  ...
  #box(height: 50%, width: 100%)[
    #align(center + horizon)[
      #box(fill: red.lighten(80%), inset: 10pt, radius: 4pt, stroke: 1pt + red)[
  ...
  #pagebreak()
  #block(inset: 8pt, stroke: (thickness: 1pt, dash: "dashed", paint: red))[#smallcaps()[#text(fill: red, weight: "black")[Level 1]]]
  ...
  #block(inset: 8pt, stroke: (thickness: 1pt, dash: "dashed", paint: red))[#smallcaps()[#text(fill: red, weight: "bold")[Level 2]]]
  #v(2mm)
  #align(center)[
    #diagram(
      node((3, 0), shape: "circle", stroke: 0.5pt, inset: 8pt)[
