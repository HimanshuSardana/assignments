...
// = #text(fill: orange)[Food Delivery System]
...
#solution()[
  #block(inset: 8pt, stroke: (
    ...
    dash: "dashed",
    paint: orange,
  ))[#smallcaps()[#text(fill: orange, weight: "bold")[Level 0]]]
  ...
  #block(inset: 8pt, stroke: (
    ...
    dash: "dashed",
    paint: orange,
  ))[#smallcaps()[#text(fill: orange, weight: "black")[Level 1]]]
  ...
  #block(inset: 8pt, stroke: (
    ...
    dash: "dashed",
    paint: orange,
  ))[#smallcaps()[#text(fill: orange, weight: "bold")[Level 2]]]
  #v(2mm)
  #align(center)[
    #diagram(
      node((3, 0), shape: "circle", stroke: 0.5pt, inset: 8pt)[
