...
```sql
INSERT INTO Student VALUES (102303244, 'Nitish', '04-JUN-2005', 'M', '2C21', 'Thapar', 'Patiala', 25);
...
|-----------|------------------|-------------|--------|-------|---------|----------|-------|
| 102303244 | Nitish | 04-JUN-2005 | M      | 2C21  | Thapar  | Patiala  | 25    |
...
INSERT INTO Emp VALUES (1, 'Nitish', 'IT Manager', 10000, 1000, 1);
...
- concat(char1, char2)
```sql
SELECT concat('Nitish', ' ', 'Sardana') FROM dual;
```

**OUTPUT** 
```txt
| CONCAT('nitish',' ','SARDANA') |
|----------------------------------|
| Nitish                 |
```
...
- instr(string, char)
```sql
SELECT instr('Nitish', 'a') FROM dual;
```
...
- length(n)
```sql
SELECT length('Nitish') FROM dual;
```
...
```sql
SELECT lpad('Nitish', 10, '*') FROM dual;
```
...
- ltrim(string, char)
```sql
SELECT ltrim('Nitish', 'H') FROM dual;
```
...
```sql
SELECT rpad('Nitish', 10, '*') FROM dual;
```
...
- rtrim(string, char)
```sql
SELECT rtrim('Nitish', 'u') FROM dual;
```
...
```sql
SELECT replace('Nitish', 'a', 'A') FROM dual;
```
...
```sql
SELECT substr('Nitish', 2, 4) FROM dual;
```
...
- initcap(char)
```sql
SELECT initcap('nitish sardana') FROM dual;
```
...
```sql
SELECT translate('Nitish', 'H', 'h') FROM dual;
```

**OUTPUT** 
```txt
| TRANSLATE('nitish','H','H') |
|-------------------------------|
| nitish                      |
```
...
INSERT INTO EMP (EMPNO, EMPNAME, DEPTNO, JOB, SALARY) VALUES (1, 'Nitish', 10, 'IT Manager', 10000);
